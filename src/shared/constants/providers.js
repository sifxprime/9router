...
export const APIKEY_PROVIDERS = {
  ...
  pollinations: { id: "pollinations", alias: "poll", name: "Pollinations AI", icon: "eco", color: "#22C55E", textIcon: "PL", website: "https://pollinations.ai", notice: { text: "Free, no signup — OpenAI, Mistral, Gemini, DeepSeek, Claude, and more." }, passthroughModels: true, noAuth: true, serviceKinds: ["llm"] },
