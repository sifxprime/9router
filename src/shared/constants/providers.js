...
export const APIKEY_PROVIDERS = {
  ...
  pollinations: { id: "pollinations", alias: "poll", name: "Pollinations AI", icon: "eco", color: "#22C55E", textIcon: "PL", website: "https://pollinations.ai", notice: { text: "Free API key — OpenAI, Mistral, Gemini, DeepSeek, Claude, Grok, and 30+ models.", apiKeyUrl: "https://enter.pollinations.ai" }, passthroughModels: true, serviceKinds: ["llm"] },
